...
exports.Crystal.prototype = {
    ...
    handle: function (request, cb) {
        ...
        this.options.realNamespace = request.protocol + '://' + request.headers.host + '/';
    ...
    respond: function (result, cb) {
        ...
        // Replace faked host in Location header
        if (result.headers.Location) {
            result.headers.Location = result.headers.Location.replace(
                this.options.fakeNamespace,
                this.options.realNamespace);
        }

        rdf.hashDescription(result.body, function (err, hash) {
