...
var parse = exports.parse = function (stream, format, cb) {
  var parser      = raptor.newParser(format),
    ...
    parser.on('statement', function (statement)           { merge(description, statement); });
...
exports.serialize = function (description, format, cb) {
    var body       = '',
...
var merge = function (target, statement) {
    ...
    if (statement.object.type === 'typed-literal') { object.datatype = statement.object.type; }
