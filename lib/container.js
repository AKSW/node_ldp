...
var Container = exports.Container = function (store) {
    ...
    Container.prototype.create = function (containerURI, uri, description, cb) {
        if (arguments.length === 3) {
            // only 3 parameters: interpret as uri, description, cb
            return _store.create(containerURI, uri, description);
        }
    ...
    Container.prototype.exists = function (containerURI, uri, cb) {
        if (arguments.length === 2) {
            // only 2 parameters: interpret as uri, cb
            return _store.exists(containerURI, uri);
        }
